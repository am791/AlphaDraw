...
var words = [
    "cup", "letter", "number", "person", "pen", "thief", "people",
    "sound", "water", "burger", "cycle", "men", "pizza", "woman", "hand", "boy",
    "girl", "phone", "tree", "week", "month", "name", "infinite", "line", "sun",
    "land", "home", "egg", "house", "camera", "animal", "mother", "father",
    "knee", "sister", "wood", "head", "page", "country", "keyboard",
    "foot", "school", "plant", "food", "sun", "state", "eye", "city", "tree",
    "grass", "bird", "sea", "night", "day", "van", "north", "south", "east",
    "west", "child", "cat", "apple", "paper", "music", "river", "car",
    "building", "feet", "book", "mango", "room", "heart", "youtube", "fish",
    "mountain", "horse", "watch", "nemo", "face", "wood", "paypal", "bird",
    "body", "mouse", "family", "song", "door", "joker", "wind", "ship", "triangle",
    "rock", "earth", "fire", "laptop", "airplane", "santa", "hut", "king",
    "space", "whale", "unicorn", "india", "bench", "chess", "ambulance", "cloud", "leaf", "moon"
];
...
io.on('connection', function (socket) {
	...
	socket.on('join', function(name) {
		...
		// place the userin the 'guesser' room
		else {
